...
[![Go Report Card](https://goreportcard.com/badge/github.com/10xLabs/gomarkdoc)](https://goreportcard.com/report/github.com/10xLabs/gomarkdoc)
[![GitHub Actions](https://github.com/10xLabs/gomarkdoc/workflows/Test/badge.svg)](https://github.com/10xLabs/gomarkdoc/actions?query=workflow%3ATest+branch%3Amaster)
[![Go Reference](https://pkg.go.dev/badge/github.com/10xLabs/gomarkdoc.svg)](https://pkg.go.dev/github.com/10xLabs/gomarkdoc)

# gomarkdoc

```go
import "github.com/10xLabs/gomarkdoc"
```
...
```
GO111MODULE=on go get -u github.com/10xLabs/gomarkdoc/cmd/gomarkdoc
```
...
```
gomarkdoc --repository.url "https://github.com/10xLabs/gomarkdoc" --repository.default-branch master --repository.path / -o README.md .
```
...
## type [Renderer](https://github.com/10xLabs/gomarkdoc/blob/master/renderer.go#L15-L19)
...
### func [NewRenderer](https://github.com/10xLabs/gomarkdoc/blob/master/renderer.go#L30)
...
### func \(\*Renderer\) [Example](https://github.com/10xLabs/gomarkdoc/blob/master/renderer.go#L140)
...
### func \(\*Renderer\) [File](https://github.com/10xLabs/gomarkdoc/blob/master/renderer.go#L112)
...
### func \(\*Renderer\) [Func](https://github.com/10xLabs/gomarkdoc/blob/master/renderer.go#L126)
...
### func \(\*Renderer\) [Package](https://github.com/10xLabs/gomarkdoc/blob/master/renderer.go#L119)
...
### func \(\*Renderer\) [Type](https://github.com/10xLabs/gomarkdoc/blob/master/renderer.go#L133)
...
## type [RendererOption](https://github.com/10xLabs/gomarkdoc/blob/master/renderer.go#L22)
...
### func [WithFormat](https://github.com/10xLabs/gomarkdoc/blob/master/renderer.go#L102)
...
### func [WithTemplateOverride](https://github.com/10xLabs/gomarkdoc/blob/master/renderer.go#L88)
